export const toastMessages = {
  ...
  loginNameRequired: "Enter your name.",
  ...
  applicationPinned: "Application pinned.",
  applicationPinFailed: "Failed to pin application",
  applicationUnpinned: "Application unpinned.",
  applicationUnpinFailed: "Failed to unpin application",
  ...
  changePasswordNewRequired: "Enter a new password.",
