  ...
  return (
    <Label
      className={cn(
        ...
        "border-border bg-background hover:bg-muted dark:border-input dark:bg-input/30 dark:hover:bg-input/50 shrink-0 cursor-pointer rounded-lg border px-2.5 font-normal transition-colors",
        includeArchived && "border-primary/50 bg-primary/5 dark:bg-primary/10",
        className,
      )}
    >
      <Checkbox
